...
coordinates = [
    ...
    [[245, 166], [294, 106], [332, 53], [253, 62], [188, 77], [134, 125],
     [73, 178], [146, 176], [205, 116]],
    [[248, 264], [150, 270], [69, 268], [130, 342], [177, 399], [249, 408],
     [332, 416], [291, 350], [206, 348]]]
avgcol = [
...
tilecol = [["o", "o", "o", "o", "o", "o", "o", "o", "o"],
           ...
           ["o", "o", "o", "o", "o", "o", "o", "o", "o"],
           ["o", "o", "o", "o", "o", "o", "o", "o", "o"]]
correct_1 = [["w", "g", "r", "r", "w", "y", "r", "g", "b"],
             ["b", "o", "o", "g", "g", "b", "y", "y", "o"],
             ["o", "r", "y", "o", "w", "w", "y", "b", "w"],
             ["o", "g", "o", "w", "b", "b", "g", "o", "g"],
             ["g", "w", "r", "y", "b", "r", "r", "b", "r"],
             ["y", "y", "b", "w", "g", "r", "w", "o", "y"]]
correct_2 = [["o", "b", "g", "g", "o", "y", "r", "g", "b"],
             ["w", "g", "o", "g", "r", "o", "y", "w", "r"],
             ["b", "w", "w", "b", "y", "y", "y", "r", "y"],
             ["b", "w", "b", "y", "b", "b", "r", "o", "g"],
             ["r", "b", "g", "r", "g", "o", "g", "y", "o"],
             ["w", "r", "w", "o", "o", "y", "y", "r", "w"]]
correct_3 = [["r", "g", "g", "g", "y", "b", "r", "o", "w"],
             ["w", "o", "o", "b", "o", "y", "o", "w", "b"],
             ["g", "y", "b", "w", "y", "y", "y", "b", "o"],
             ["y", "o", "b", "w", "b", "b", "g", "r", "y"],
             ["r", "g", "o", "r", "w", "r", "r", "w", "g"],
             ["b", "o", "g", "y", "w", "r", "w", "g", "r"]]
correct_4 = [["b", "b", "b", "o", "y", "w", "w", "g", "r"],
             ["o", "y", "o", "r", "g", "y", "y", "y", "y"],
             ["w", "w", "r", "o", "r", "w", "y", "r", "b"],
             ["w", "w", "w", "g", "b", "b", "g", "b", "o"],
             ["g", "r", "y", "y", "b", "r", "g", "g", "w"],
             ["o", "o", "o", "b", "r", "g", "r", "o", "g"]]
correct_5 = [["r", "w", "g", "w", "o", "g", "r", "y", "w"],
             ["y", "b", "o", "g", "o", "r", "y", "g", "b"],
             ["b", "o", "b", "w", "g", "y", "y", "y", "o"],
             ["g", "r", "w", "r", "b", "g", "r", "b", "y"],
             ["r", "r", "w", "b", "w", "o", "w", "b", "g"],
             ["y", "o", "b", "o", "o", "y", "g", "w", "r"]]
correct_6 = [["w", "y", "w", "b", "w", "b", "w", "r", "w"],
             ["b", "b", "o", "g", "r", "o", "r", "o", "b"],
             ["o", "y", "r", "o", "r", "w", "y", "y", "o"],
             ["g", "y", "b", "r", "b", "r", "g", "w", "y"],
             ["y", "b", "y", "w", "b", "r", "o", "g", "g"],
             ["o", "w", "g", "o", "g", "g", "y", "g", "r"]]
correct_7 = [["o", "y", "r", "y", "o", "g", "w", "g", "r"],
             ["y", "o", "o", "g", "y", "r", "b", "b", "g"],
             ["g", "y", "r", "o", "o", "b", "y", "g", "r"],
             ["w", "r", "g", "r", "b", "w", "g", "o", "o"],
             ["r", "w", "w", "b", "b", "w", "w", "r", "b"],
             ["g", "y", "b", "o", "y", "b", "r", "w", "w"]]
correct_8 = [["w", "b", "y", "r", "r", "o", "r", "y", "b"],
             ["o", "b", "o", "o", "y", "y", "o", "o", "y"],
             ["g", "o", "y", "g", "w", "w", "y", "w", "o"],
             ["w", "g", "g", "w", "b", "r", "b", "r", "g"],
             ["b", "g", "o", "y", "b", "g", "w", "b", "w"],
             ["r", "r", "g", "y", "g", "b", "r", "w", "r"]]
correct_9 = [["y", "o", "g", "r", "y", "r", "w", "b", "r"],
             ["g", "g", "o", "b", "b", "w", "w", "w", "y"],
             ["o", "o", "o", "r", "y", "o", "y", "y", "b"],
             ["b", "r", "w", "w", "b", "y", "r", "b", "o"],
             ["r", "y", "g", "b", "g", "g", "b", "g", "w"],
             ["w", "o", "r", "w", "r", "g", "o", "y", "g"]]
correct_10 = [["o", "o", "g", "y", "g", "y", "r", "b", "o"],
              ["w", "b", "o", "b", "y", "b", "w", "w", "g"],
              ["b", "r", "b", "y", "y", "r", "y", "y", "w"],
              ["g", "w", "g", "w", "b", "g", "b", "r", "r"],
              ["y", "w", "r", "o", "w", "g", "w", "g", "b"],
...
for i in range(6):
    for j in range(9):
        for k in range(6):
            if tilecol[i][j] != correct_10[i][j] and correct_10[i][j] == \
                    colors[k]:
                error[k] += 1
for i in range(6):
    right[i] = error[colors.index(reihenfolge[i])]
