...
\lstinputlisting[language=Python, linerange={289-309}]{testing_correct_num.py}
...
\lstinputlisting[language=Python, linerange={266-286}]{testing_correct_num.py}
\subsubsection{Vergleich}
...
\lstinputlisting[language=Python, linerange={68-88}]{listings.py} 
\end{document}
